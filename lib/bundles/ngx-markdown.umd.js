(function (global, factory) {
    ...
    LanguagePipe.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: LanguagePipe, deps: [], target: i0__namespace.ɵɵFactoryTarget.Pipe });
    LanguagePipe.ɵpipe = i0__namespace.ɵɵngDeclarePipe({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: LanguagePipe, name: "language" });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: LanguagePipe, decorators: [{
                type: i0.Pipe,
                args: [{
                        name: 'language',
                    }]
    ...
    ***************************************************************************** */
    ...
    MarkdownService.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: MarkdownService, deps: [{ token: i0.PLATFORM_ID }, { token: SECURITY_CONTEXT }, { token: i1__namespace.HttpClient, optional: true }, { token: MarkedOptions, optional: true }, { token: i3__namespace.DomSanitizer }], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    MarkdownService.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: MarkdownService });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: MarkdownService, decorators: [{
                type: i0.Injectable
    ...
    MarkdownComponent.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: MarkdownComponent, deps: [{ token: i0__namespace.ElementRef }, { token: MarkdownService }], target: i0__namespace.ɵɵFactoryTarget.Component });
    MarkdownComponent.ɵcmp = i0__namespace.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "12.0.5", type: MarkdownComponent, selector: "markdown, [markdown]", inputs: { data: "data", src: "src", emoji: "emoji", katex: "katex", katexOptions: "katexOptions", lineHighlight: "lineHighlight", line: "line", lineOffset: "lineOffset", lineNumbers: "lineNumbers", start: "start" }, outputs: { error: "error", load: "load", ready: "ready" }, usesOnChanges: true, ngImport: i0__namespace, template: '<ng-content></ng-content>', isInline: true });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: MarkdownComponent, decorators: [{
                type: i0.Component,
                args: [{
    ...
    MarkdownPipe.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: MarkdownPipe, deps: [{ token: i0__namespace.ElementRef }, { token: MarkdownService }, { token: i0__namespace.NgZone }], target: i0__namespace.ɵɵFactoryTarget.Pipe });
    MarkdownPipe.ɵpipe = i0__namespace.ɵɵngDeclarePipe({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: MarkdownPipe, name: "markdown" });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: MarkdownPipe, decorators: [{
                type: i0.Pipe,
                args: [{
                        name: 'markdown',
                    }]
    ...
    MarkdownModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: MarkdownModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    MarkdownModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: MarkdownModule, declarations: [LanguagePipe,
            MarkdownComponent,
            MarkdownPipe], exports: [LanguagePipe,
            MarkdownComponent,
            MarkdownPipe] });
    MarkdownModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: MarkdownModule });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.5", ngImport: i0__namespace, type: MarkdownModule, decorators: [{
                type: i0.NgModule,
                args: [{
